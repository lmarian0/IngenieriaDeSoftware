...
public class   Main {
   public static void main(String[] args) {
      ...
      enemies.add(new Enemy("Pedroni", 2, 100, 20, 1, 1000, 0, null));
      enemies.add(new Enemy("Ayarde", 2, 50, 35, 1, 1000, 0, null));
      enemies.add(new Enemy("Briones", 2, 75, 80, 1, 1000, 0, null));
